...
{{% blocks/feature icon="fa-lightbulb" title="Advanced Ergonomics" %}}

Split design reduces wrist strain and promotes natural hand positioning for healthier typing.

{{% /blocks/feature %}}

{{% blocks/feature icon="fab fa-bluetooth" title="Wireless Freedom" %}}

Seamless wireless technology for clutter-free workspace and maximum mobility.

{{% /blocks/feature %}}

{{% blocks/feature icon="fas fa-sliders-h" title="Full Customization" %}}

Customizable key mappings, switch types, and personalized configuration options.
