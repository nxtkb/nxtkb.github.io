...
{{% blocks/feature icon="fa-lightbulb" title="先进的人体工学设计" %}}

分体式设计减少手腕压力，促进自然手部姿势，实现更健康的打字体验。

{{% /blocks/feature %}}

{{% blocks/feature icon="fab fa-bluetooth" title="无线自由" %}}

无缝无线技术，打造无杂乱的工作空间，实现最大移动性。

{{% /blocks/feature %}}

{{% blocks/feature icon="fas fa-sliders-h" title="全面自定义" %}}

可自定义键位映射、轴体类型和个人配置选项。
